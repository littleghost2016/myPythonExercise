...
import re
# regex = '[A-Z]{3}[a-z][A-Z]{3}' -----It doesn't work!
# It says One small letter, surrounded by <b>EXACTLY</b> three big bodyguards on each of its sides. There must be 3 big, not 4 or 5 or more.
regex = '[a-z][A-Z]{3}[a-z][A-Z]{3}[a-z]'
print(''.join(c[4] for c in re.findall(regex, text)))

# The key is linkedlist.
# If you open the url with 'linkedlist.html', it will display 'linkedlist.php'
# So the url is http://www.pythonchallenge.com/pc/def/linkedlist.php
